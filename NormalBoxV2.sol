...
contract DracooBox is Context, Ownable, MinterRole, Pausable, ERC721, ReentrancyGuard {
    ...
    uint256 public constant CAP = 300;
    uint256 public constant PRICE = 300 * 1e18;   // 300 BUSD
    ...
    constructor(address busdAddress) ERC721("Dracoo Box In Galler", "DracooBoxGaller") public {
        saleIsActive = false;
    ...
    function buyNormalBox(uint256 amounts) public nonReentrant{
